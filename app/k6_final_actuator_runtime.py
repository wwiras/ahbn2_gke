"""K6 runtime inheriting the frozen K5 S5 actuator behavior.

The canonical controller and peer modules remain untouched. This wrapper differs
from the K5 runtime only in importing the K6 stage-specific policy copy.
"""
...
import peer
from k6_final_actuator_policy import TREATMENTS, requested_fanout


def _configured_treatment() -> str:
    topology_path = os.environ.get("TOPOLOGY_PATH", "/config/topology.json")
